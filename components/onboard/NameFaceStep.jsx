  ...
  return (
    <section className="mx-auto max-w-xl px-6 pt-6 pb-16">
      ...
      <label className="mt-6 block">
        ...
        <input className="mt-1 w-full rounded-xl border px-3 py-2" placeholder={t.nameFace.placeholders.name}
               value={name} onChange={(e) => setName(e.target.value)} required />
      </label>

      <label className="mt-4 block">
        <span className="text-sm font-medium">{t.nameFace.labels.surname}</span>
        <input className="mt-1 w-full rounded-xl border px-3 py-2" placeholder={t.nameFace.placeholders.surname}
