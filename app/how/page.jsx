...
export default function How() {
  return (
    <>
      <Head>
        <title>How — Gatishil Nepal</title>
        <meta name="description" content="How Gatishil works: daily democracy, cooperative wealth, transparent ledgers, and device-bound trust." />
      </Head>
