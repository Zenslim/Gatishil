...
function SectionTitle({
  ...
  return (
    <div id={id} className="text-center max-w-3xl mx-auto mb-8 px-2">
      {kicker && (
        <p className="uppercase tracking-widest text-[10px] text-amber-300/85">
          {kicker}
        </p>
      )}
      <h2 className="text-2xl sm:text-3xl font-bold mt-2">{title}</h2>
      {subtitle && (
        <p className="text-sm sm:text-base text-slate-300/85 mt-3">{subtitle}</p>
      )}
    </div>
  );
}

/** Starfield — background symbolic layer
 *  Represents the vast, unconditioned space of the Sovereign Self.
 */
function Starfield() {
  ...
  return (
    <motion.div style={{ opacity }} className="fixed inset-0 -z-10 pointer-events-none">
      ...
      <style jsx>{`
        ...
        .layer-l {
          background-image: radial-gradient(white 2px, transparent 2.5px),
...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16 grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              We unite self-awareness with transparent systems to end corruption from
              the inside out.
            </motion.p>
          ...
          >
            <div className="grid grid-cols-2 h-full">
              {/* IMPORTANT: add images to /public/inner-flow.jpg */}
      ...
      <section className="relative z-10 py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
          <SectionTitle
            ...
            subtitle="A movement built on Inner Clarity, Transparent Systems, and a Collective Awakening."
          />
          ...
          <div className="max-w-5xl mx-auto grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-7">
            ...
            >
              ...
              <p className="mt-2 text-slate-300/85 text-sm">
                Transformation begins with self-knowledge. A citizen aware of their
                fear, craving, and ego cannot be manipulated by any throne.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-2 text-slate-300/85 text-sm">
                When every rupee shines and every decision is visible, corruption dies
                naturally. Transparency is not a rule — it is a light.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl bg-white/5 border border-white/10"
            >
              <h3 className="text-lg font-semibold">🕊 Collective Awakening</h3>
              <p className="mt-2 text-slate-300/85 text-sm">
                When individuals awaken together, the collective becomes powerful
                enough to make any throne irrelevant.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      {/* MANIFESTO FULL — 8 PILLARS */}
      <section id="manifesto" className="relative z-10 py-12 sm:py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
          <SectionTitle
            kicker="Manifesto"
          ...
          <div className="max-w-6xl mx-auto grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl bg-white/5 border border-white/10"
            >
              <h3 className="font-semibold text-lg">👁️ Awareness — The Sovereign Self</h3>
              <p className="mt-2 text-sm text-slate-300/85">
                Inner clarity is the root of all outer reform. A free person cannot
                elect a tyrant. Awareness uproots fear, greed, and blind allegiance.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-300/85">
                True prosperity is self-reliance, not borrowed survival. When we
                distinguish between need and craving, our economy grows from dignity,
                not dependency.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-300/85">
                The law must be blind, especially toward the powerful. Only an awakened
            ...
            >
              <h3 className="font-semibold text-lg">
                🌍 Transparency — The Inner Light Made Visible
              </h3>
              <p className="mt-2 text-sm text-slate-300/85">
                Every rupee should shine, every decision be seen. We open the books of
                the nation only after we open the book of our own heart.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-300/85">
                Our unity is our great strength — not a fearful herd, but a communion
                of free individuals forming one harmony.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-300/85">
                Leadership is duty, not business. Only one who has mastered their own
                ego can serve others without corruption.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-300/85">
                Many voices, one flow. We celebrate the cultural rivers that arise
                when individuals are not afraid to be themselves.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl bg-white/5 border border-white/10"
            >
              <h3 className="font-semibold text-lg">❤️ Freedom — Remember the Sky</h3>
              <p className="mt-2 text-sm text-slate-300/85">
                Freedom is our natural state. A bird forgets the sky only when caged
                too long. We dismantle the throne because we remember we are not
                subjects, but sovereigns.
              </p>
            </motion.div>
