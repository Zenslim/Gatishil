...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-black text-white relative overflow-hidden">
      {/* Cosmic gradients (like homepage) */}
      ...
      <header className="relative z-10 w-full border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-16 py-4 flex items-center justify-between">
          <h1 className="text-lg md:text-2xl font-semibold tracking-tight fade-up">
            True Tax Mirror
          </h1>
      ...
      {/* Calculator (full viewport). No blue box — just subtle glow edges like home. */}
      <section className="relative z-10">
      ...
      {/* Page-local styles for motion and starfield */}
      <style jsx>{`
        .fade-up {
          opacity: 0;
