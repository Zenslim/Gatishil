...
export async function GET(req: Request) {
  ...
  // List cookies visible to SSR on THIS host
  ...
  // Legacy JSON cookie
  const legacyRaw = ck.get('supabase-auth-token')?.value || null;
  ...
  // Build a Supabase SSR client that falls back to legacy cookie values
