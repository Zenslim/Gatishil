...
// Load TinaAdmin from the top-level 'tinacms' entry to avoid 'dist/admin' subpath issues
const TinaAdmin = dynamic(
  () =>
    import('tinacms').then((m: any) => {
      if (m?.TinaAdmin) return m.TinaAdmin;
      // Graceful fallback with a helpful message if Admin isn't available in this version
