...
export default function What() {
  return (
    <>
      <Head>
        <title>What — Gatishil Nepal</title>
        <meta name="description" content="What Gatishil is: a DAO party rooted in Nepali guthi wisdom, rebuilt with modern transparency." />
      </Head>
